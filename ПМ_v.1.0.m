let
    // Источник данных
    Источник = Excel.CurrentWorkbook(){[Name="Расходы_ПМ"]}[Content],
    ...
    // Удаляю всё лишнее
    RemowedRows = Table.RemoveColumns(FilteredRows,{"№", "employee_accounting_type", "Август", "Сентябрь", "Октябрь", "Ноябрь", "Декабрь", "Январь", "Февраль", "Март", "Апрель", "Май", "Июнь", "Июль", "Итого"}),
